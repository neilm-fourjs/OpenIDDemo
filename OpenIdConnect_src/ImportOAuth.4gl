...
# Property of Four Js*
# (c) Copyright Four Js 2018, 2023. All Rights Reserved.
...
FUNCTION DoImport(p_issuer, p_authz, p_token, p_userinfo, p_logout, p_keys)
  DEFINE p_issuer   URLType
  DEFINE p_authz    URLType
  DEFINE p_token    URLType
  DEFINE p_userinfo URLType
  DEFINE p_logout   URLType
  DEFINE p_keys     URLType
  TRY
